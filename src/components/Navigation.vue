...
<style scoped lang="scss">
  ...
  .main-header { display:flex; padding:$gutter; background-color:$beige;
    ...
    .main-navigation { flex:1 0 auto; }
  }

  .home-link {
    a { display:inline-block; line-height:$logo-size; text-decoration:none; font-size:1.5rem; font-weight:bold; color:$black; padding-right:$gutter; border-radius:35px; transition: background-color 0.3s ease;
  ...
  .main-navigation {
    ul { list-style:none; margin:15px 0 0; padding-left:0;
      li { display:inline-block; }
    }
    a { text-decoration:none; font-size:1.2rem; font-weight:bold; color:$black; padding:$gutter $gutter ($gutter/2); display:block; 
